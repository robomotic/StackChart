...
class ViewController: UIViewController {
    ...
    func drawPressureChart(dayson:Bool=true)
    {
        ...
        let yValues = ChartAxisValuesGenerator.generateYAxisValuesWithChartPoints(allChartPoints, minSegmentCount: 1, maxSegmentCount: 20, multiple: 1.0, axisValueGenerator: {ChartAxisValueDouble($0, labelSettings: labelSettings_temp)}, addPaddingSegmentIfEdge: true)
        ...
        let chartFrame = GraphDefaults.chartFrame(AreaPlotPressure.frame)
